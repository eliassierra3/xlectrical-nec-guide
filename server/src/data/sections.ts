...
export const sections: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: { en: 'Sizing & capacity (702.4)', es: 'Dimensionamiento y capacidad (702.4)' } },
      {
        type: 'list',
        items: [
          { en: 'Size the generator to the load you will actually run. Load management (load-shed) lets a smaller unit back up a whole house.', es: 'Dimensiona el generador a la carga que realmente vas a usar. El manejo de cargas (load-shed) deja que un equipo más chico respalde toda la casa.' },
          { en: 'Automatic systems: capacity for the full load, OR use load management. Manual systems: capacity for the loads you will switch on.', es: 'Sistemas automáticos: capacidad para toda la carga, O usa manejo de cargas. Sistemas manuales: capacidad para las cargas que vas a encender.' },
        ],
      },
