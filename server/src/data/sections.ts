...
export const sections: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'heading', text: { en: 'Commercial & larger services', es: 'Comercial y servicios grandes' } },
      {
        type: 'list',
        items: [
          { en: '3-phase metering (Fig. IV-8): meter symbols — 4-wire 3φ delta = "J", wye = "L"/"N". On a 240 V delta the high leg (Hot #3) is 208 V to ground and MUST land on the RIGHT terminal; the other two hots are 120 V lighting legs. A 120/208 V 3-wire uses a 5th terminal (9 o’clock position only).', es: 'Medición trifásica (Fig. IV-8): símbolos — 4 hilos 3φ delta = "J", estrella = "L"/"N". En un delta de 240 V la pierna alta (Hot #3) es 208 V a tierra y DEBE ir en la terminal DERECHA; los otros dos vivos son piernas de 120 V. El 3 hilos 120/208 V usa una 5.ª terminal (solo en la posición de las 9).' },
          { en: 'CT / instrument-transformer metering: when the load exceeds 600 A, or the service-entrance conductors exceed one 800 kcmil or two 500 kcmil per phase, FPL normally requires a current-transformer (CT) cabinet + an instrument-transformer-rated meter socket installed ahead of the service equipment, plus a 1½ in conduit from the cabinet to the socket. FPL provides & installs the CTs — buy the CT-rated socket, not self-contained.', es: 'Medición con CT (transformadores de instrumento): cuando la carga excede 600 A, o los conductores de acometida exceden un 800 kcmil o dos 500 kcmil por fase, FPL normalmente exige un gabinete de CT + una base tipo instrumento delante del equipo de servicio, más una tubería de 1½ in del gabinete a la base. FPL provee e instala los CT — compra la base tipo CT, no autocontenida.' },
          { en: 'Primary metering: padmounted — customer provides a metering cabinet from FPL’s approved list (or FPL provides and bills); in a vault — FPL provides, owns & maintains the cabinet. Coordinate your primary service equipment with FPL’s feeder protection.', es: 'Medición primaria: padmounted — el cliente provee un gabinete de la lista aprobada de FPL (o FPL lo provee y cobra); en bóveda — FPL provee, es dueño y mantiene el gabinete. Coordina tu equipo de servicio primario con la protección de FPL.' },
          { en: 'Interrupting rating: the service equipment must safely interrupt the maximum available fault current — ask FPL for the available fault current and allow for future increases.', es: 'Capacidad interruptiva: el equipo de servicio debe interrumpir con seguridad la corriente de falla máxima disponible — pídele a FPL la corriente de falla disponible y prevé aumentos futuros.' },
          { en: 'Multiple meter centers (Fig. IV-12b): must be on FPL’s Approved List; provide sealing for each breaker (1/16 in hole in the handle); fiber/metal barriers separating line wires from metered circuits; permanent, durable ID on both meter and breaker; top-meter centerline 72 in max. Non-residential & 3φ require lever bypass.', es: 'Centros de medidores múltiples (Fig. IV-12b): deben estar en la Lista Aprobada de FPL; sellado para cada breaker (orificio de 1/16 in en la palanca); barreras de fibra/metal que separan los vivos de línea de los circuitos medidos; ID permanente y durable en medidor y breaker; línea central del medidor superior 72 in máx. No residencial y 3φ requieren bypass de palanca.' },
        ],
      },
      {
        type: 'diagram',
        diagram: 'fpl-iv8',
        caption: {
          en: 'FPL Fig. IV-8 — self-contained meter wiring & meter symbols (1φ and 3φ), the delta hi-leg on the right terminal, and meter cans with bypass handles.',
          es: 'FPL Fig. IV-8 — cableado y símbolos de medidor (1φ y 3φ), la pierna alta del delta en la terminal derecha, y cajas con palancas de bypass.',
        },
      },
      {
        type: 'diagram',
        diagram: 'fpl-iv12b',
        caption: {
          en: 'FPL Fig. IV-12b — residential/commercial multiple meter center: dimensions, per-breaker sealing, line/load barriers, and permanent identification.',
          es: 'FPL Fig. IV-12b — centro de medidores múltiples (residencial/comercial): dimensiones, sellado por breaker, barreras línea/carga e identificación permanente.',
        },
      },
  ...
  },
  {
    ...
    number: '17',
    category: 'requirements',
    necRef: 'NEC 702 / 445 / 250',
    title: {
      en: 'Generator Installation',
      es: 'Instalación de generadores',
    },
    subtitle: {
      en: 'Portable and permanent standby — transfer, grounding, clearances, and safety.',
      es: 'Portátil y respaldo permanente — transferencia, tierra, distancias y seguridad.',
    },
    keywords: ['generator', 'standby', 'transfer switch', 'ats', 'interlock', 'backfeed', 'portable', 'inlet', '702', '445', 'separately derived', 'neutral', 'generador', 'respaldo', 'transferencia', 'interbloqueo', 'co'],
    blocks: [
      {
        type: 'paragraph',
        text: {
          en: 'Generators come in two forms: portable (cord → power inlet → interlock) and permanent standby (an automatic transfer switch). Either way, the #1 rule is transfer equipment so the generator and the utility can NEVER be connected at the same time — backfeed can electrocute a lineman and destroy the generator when the utility returns. Covered by NEC Article 702 (optional standby systems), 445 (the generator itself), and 250 (grounding).',
          es: 'Los generadores vienen en dos formas: portátil (cable → entrada de energía → interbloqueo) y respaldo permanente (transferencia automática). En ambos casos, la regla #1 es el equipo de transferencia para que el generador y la red NUNCA queden conectados al mismo tiempo — el backfeed puede electrocutar a un liniero y destruir el generador cuando regresa la red. Lo cubre el NEC Artículo 702 (sistemas de respaldo opcionales), 445 (el generador) y 250 (puesta a tierra).',
        },
      },
      { type: 'heading', text: { en: 'Choosing the right generator', es: 'Cómo elegir el generador correcto' } },
      {
        type: 'paragraph',
        text: {
          en: 'Most of the value you add is up front — spec’ing the right unit. Walk the customer through four questions: portable or standby? what needs to stay on? how big? and what fuel?',
          es: 'La mayor parte del valor está al inicio — especificar el equipo correcto. Lleva al cliente por cuatro preguntas: ¿portátil o standby? ¿qué debe seguir encendido? ¿de qué tamaño? y ¿qué combustible?',
        },
      },
      {
        type: 'comparison',
        title: { en: 'Portable vs Permanent standby', es: 'Portátil vs Respaldo permanente' },
        columns: [ { en: 'Portable', es: 'Portátil' }, { en: 'Permanent standby', es: 'Respaldo permanente' } ],
        rows: [
          { label: { en: 'Starts / transfers', es: 'Arranca / transfiere' }, cells: [ { en: 'You start it and flip a manual transfer/interlock', es: 'Tú lo arrancas y mueves la transferencia/interbloqueo manual' }, { en: 'Auto-starts and transfers in seconds (ATS)', es: 'Arranca y transfiere solo en segundos (ATS)' } ] },
          { label: { en: 'Must be home?', es: '¿Debes estar en casa?' }, cells: [ { en: 'Yes', es: 'Sí' }, { en: 'No — unattended', es: 'No — desatendido' } ] },
          { label: { en: 'Fuel', es: 'Combustible' }, cells: [ { en: 'Gasoline — a few hours per tank', es: 'Gasolina — pocas horas por tanque' }, { en: 'Natural gas or LP — long run time', es: 'Gas natural o LP — larga duración' } ] },
          { label: { en: 'Cost', es: 'Costo' }, cells: [ { en: '$ — lowest', es: '$ — el más bajo' }, { en: '$$$ — unit + pad + gas + install', es: '$$$ — equipo + losa + gas + instalación' } ] },
          { label: { en: 'Best for', es: 'Ideal para' }, cells: [ { en: 'Occasional outages, essentials only', es: 'Apagones ocasionales, solo lo esencial' }, { en: 'Frequent/long outages, hands-off whole-home', es: 'Apagones frecuentes/largos, casa completa sin intervención' } ] },
        ],
      },
      { type: 'heading', text: { en: 'What to power & how big', es: 'Qué alimentar y de qué tamaño' } },
      {
        type: 'paragraph',
        text: {
          en: 'Decide the scope: whole-house (biggest, most expensive) or essential loads with load management (a smaller unit sheds big loads like the AC or water heater so it can cover more). To size it, add the running watts of everything that runs at once, then add the single largest starting surge — motors (AC compressor, well pump, fridge) pull 2–3× their running watts to start, and the AC usually drives the size. A soft-start on the AC can cut that surge and let a smaller generator run it. (NEC 702.4: an automatic system must have capacity for the full load, or use load management.)',
          es: 'Define el alcance: casa completa (lo más grande y caro) o cargas esenciales con manejo de cargas (un equipo más chico corta cargas grandes como el aire o el calentador para cubrir más). Para dimensionar, suma los watts de marcha de todo lo que funciona a la vez, y súmale el mayor arranque individual — los motores (compresor de aire, bomba de pozo, refri) jalan 2–3× sus watts al arrancar, y el aire suele definir el tamaño. Un soft-start en el aire reduce ese pico y deja que un generador más chico lo mueva. (NEC 702.4: un sistema automático debe tener capacidad para toda la carga, o usar manejo de cargas.)',
        },
      },
      { type: 'table', tableSlug: 'generator-sizing' },
      { type: 'heading', text: { en: 'Fuel', es: 'Combustible' } },
      {
        type: 'list',
        items: [
          { en: 'Natural gas (NG): most convenient — utility supply, no tank, unlimited run time. Output is ~10–20% lower than LP (derate) and it needs adequate gas pressure and a properly sized line. Best where NG is available.', es: 'Gas natural (NG): lo más cómodo — suministro de la compañía, sin tanque, duración ilimitada. La salida es ~10–20% menor que con LP (derate) y necesita presión adecuada y línea bien dimensionada. Ideal donde hay NG.' },
          { en: 'LP / propane: higher output than NG; needs a tank sized for the run time you want. Very common for standby in Florida.', es: 'LP / propano: mayor salida que NG; necesita un tanque dimensionado para la duración deseada. Muy común para standby en Florida.' },
          { en: 'Gasoline: portables only — storage/stability limits, only a few hours per tank, and you refuel by hand.', es: 'Gasolina: solo portátiles — límites de almacenamiento/estabilidad, pocas horas por tanque, y recargas a mano.' },
          { en: 'Diesel: mostly larger/commercial sets — efficient, but you store fuel. Less common for homes.', es: 'Diésel: sobre todo equipos grandes/comerciales — eficiente, pero almacenas combustible. Menos común en casas.' },
        ],
      },
      { type: 'heading', text: { en: 'What the install requires', es: 'Qué requiere la instalación' } },
      {
        type: 'paragraph',
        text: { en: 'Beyond the generator itself, quote and order all of this:', es: 'Además del generador, cotiza y pide todo esto:' },
      },
      {
        type: 'list',
        items: [
          { en: 'The listed generator + its installation and owner’s manuals (clearances and gas specs come from there).', es: 'El generador listado + sus manuales de instalación y de usuario (de ahí salen las distancias y specs de gas).' },
          { en: 'Transfer equipment: an ATS (standby) or a manual transfer switch / listed interlock + power inlet box (portable). Add a load-management module if you’re shedding loads.', es: 'Equipo de transferencia: un ATS (standby) o una transferencia manual / interbloqueo listado + caja de entrada (portátil). Agrega un módulo de manejo de cargas si vas a cortar cargas.' },
          { en: 'Mounting: a level concrete or composite pad (standby); wall-mount for the inlet/ATS.', es: 'Montaje: una losa de concreto o compuesta a nivel (standby); montaje en pared para la entrada/ATS.' },
          { en: 'Conductors + a flexible whip/conduit between the generator, the transfer switch, and the panel; the generator disconnect and overcurrent.', es: 'Conductores + una manguera/tubería flexible entre el generador, la transferencia y el panel; la desconexión y protección del generador.' },
          { en: 'Grounding/bonding materials — and know the neutral rule (below) before you wire it.', es: 'Materiales de tierra/unión — y conoce la regla del neutro (abajo) antes de cablear.' },
          { en: 'Fuel: a gas line sized for the BTU load, a shutoff and regulator (NG/LP), or a fuel tank — usually a licensed gas contractor does this part.', es: 'Combustible: línea de gas dimensionada por la carga en BTU, corte y regulador (NG/LP), o un tanque — normalmente un contratista de gas con licencia hace esta parte.' },
          { en: 'For automatic standby: the starting battery + a maintainer, and the control wiring between the ATS and the generator for auto-start.', es: 'Para standby automático: la batería de arranque + un mantenedor, y el cableado de control entre el ATS y el generador para el arranque automático.' },
        ],
      },
      { type: 'heading', text: { en: 'Commission & hand off', es: 'Puesta en marcha y entrega' } },
      {
        type: 'list',
        items: [
          { en: 'Test the transfer: simulate a utility outage — the generator should auto-start, transfer, then transfer back and cool down when utility returns.', es: 'Prueba la transferencia: simula un apagón — el generador debe arrancar solo, transferir, y luego regresar y enfriarse cuando vuelve la red.' },
          { en: 'Set the weekly exercise schedule; verify the neutral bonding matches the transfer type; torque the connections; label the transfer switch and post the 702.7 sign.', es: 'Programa el ejercicio semanal; verifica que la unión del neutro concuerde con el tipo de transferencia; aprieta las conexiones; etiqueta la transferencia y coloca el letrero 702.7.' },
          { en: 'Show the customer how to operate it and the maintenance (oil, filters, fuel, and what the ATS does automatically).', es: 'Muéstrale al cliente cómo operarlo y el mantenimiento (aceite, filtros, combustible, y qué hace el ATS automáticamente).' },
        ],
      },
      { type: 'heading', text: { en: 'The golden rule: transfer equipment, no backfeed', es: 'La regla de oro: transferencia, sin backfeed' } },
      {
        type: 'paragraph',
        text: {
          en: 'NEC 702.6 requires listed transfer equipment that prevents any inadvertent interconnection of the generator and the utility. Your options: an automatic transfer switch (ATS), a manual transfer switch, or a listed generator interlock kit on the panel. NEVER a “suicide cord” (double-male plug) into a receptacle — it is illegal and deadly.',
          es: 'El NEC 702.6 exige equipo de transferencia listado que impida cualquier interconexión accidental del generador con la red. Tus opciones: transferencia automática (ATS), transferencia manual, o un kit de interbloqueo listado en el panel. NUNCA un “cable suicida” (enchufe doble macho) en un receptáculo — es ilegal y mortal.',
        },
      },
      {
        type: 'diagram',
        diagram: 'generator-transfer',
        caption: {
          en: 'Transfer equipment feeds the panel from the utility OR the generator — never both at once.',
          es: 'La transferencia alimenta el panel desde la red O el generador — nunca ambos a la vez.',
        },
      },
      { type: 'heading', text: { en: 'Portable generators', es: 'Generadores portátiles' } },
      {
        type: 'list',
        items: [
          { en: 'Run it OUTSIDE only — well away from windows, doors, and vents. Carbon monoxide (CO) kills; never run one in a garage or enclosed space, even with the door open.', es: 'Úsalo SOLO afuera — bien lejos de ventanas, puertas y rejillas. El monóxido de carbono (CO) mata; nunca lo uses en un garaje o espacio cerrado, aunque la puerta esté abierta.' },
          { en: 'Connect through a power inlet box + a listed generator interlock kit on the load center (or a manual transfer switch / subpanel). Never backfeed a dryer or range outlet with a cord.', es: 'Conéctalo por una caja de entrada de energía + un kit de interbloqueo listado en el panel (o una transferencia manual / subpanel). Nunca retroalimentes por una toma de secadora o estufa con un cable.' },
          { en: 'Size the inlet, cord, and generator breaker to the generator output. Use the generator’s GFCI outlets.', es: 'Dimensiona la entrada, el cable y el breaker del generador según la salida del generador. Usa las tomas GFCI del generador.' },
          { en: 'Neutral: match the generator (floating vs bonded neutral) to your transfer method — see “Grounding & the neutral” below.', es: 'Neutro: haz coincidir el generador (neutro flotante vs unido) con tu método de transferencia — ve “Puesta a tierra y el neutro” abajo.' },
        ],
      },
      {
        type: 'diagram',
        diagram: 'portable-inlet',
        caption: {
          en: 'Portable generator → power inlet box → a listed interlock so only the main OR the generator breaker can be on.',
          es: 'Generador portátil → caja de entrada → un interbloqueo listado para que solo el main O el breaker del generador estén encendidos.',
        },
      },
      { type: 'heading', text: { en: 'Permanent standby (automatic)', es: 'Respaldo permanente (automático)' } },
      {
        type: 'steps',
        title: { en: 'Installing an air-cooled standby set', es: 'Instalar un generador de respaldo enfriado por aire' },
        steps: [
          { en: 'Set it on a level concrete or composite pad, per the manufacturer.', es: 'Colócalo en una losa de concreto o compuesta a nivel, según el fabricante.' },
          { en: 'Clearances: follow the unit’s LISTED clearances (commonly ~18 in from the wall; 5 ft from doors, windows, and fresh-air intakes; keep 3 ft of service access) and NFPA 37. Point the exhaust away from openings.', es: 'Distancias: sigue las distancias LISTADAS del equipo (típico ~18 in de la pared; 5 ft de puertas, ventanas y tomas de aire; deja 3 ft de acceso de servicio) y NFPA 37. Dirige el escape lejos de aberturas.' },
          { en: 'Wire in the Automatic Transfer Switch (ATS): whole-house, with load management (load-shed), or feeding an essential-loads subpanel.', es: 'Conecta la transferencia automática (ATS): casa completa, con manejo de cargas (load-shed), o alimentando un subpanel de cargas esenciales.' },
          { en: 'Provide the generator disconnect and overcurrent (445.18). Size the output conductors at ≥ 115% of the nameplate current (445.13).', es: 'Provee la desconexión y protección del generador (445.18). Dimensiona los conductores de salida a ≥ 115% de la corriente de placa (445.13).' },
          { en: 'Fuel (natural gas or LP): add a gas shutoff and size the gas line for the unit’s BTU load; coordinate with the gas contractor.', es: 'Combustible (gas natural o LP): agrega un corte de gas y dimensiona la línea para la carga en BTU del equipo; coordina con el contratista de gas.' },
        ],
      },
      { type: 'heading', text: { en: 'Grounding & the neutral (the tricky part)', es: 'Puesta a tierra y el neutro (lo complicado)' } },
      {
        type: 'paragraph',
        text: {
          en: 'Whether the generator is a separately derived system — and therefore whether you bond the neutral at the generator — depends on ONE thing: does the transfer switch switch the neutral?',
          es: 'Si el generador es un sistema derivado por separado — y por tanto si unes el neutro en el generador — depende de UNA cosa: ¿la transferencia conmuta el neutro?',
        },
      },
      {
        type: 'comparison',
        title: { en: 'Neutral bonding by transfer type', es: 'Unión del neutro por tipo de transferencia' },
        columns: [
          { en: '3-pole — neutral solid (not switched)', es: '3 polos — neutro sólido (no conmuta)' },
          { en: '4-pole — neutral switched', es: '4 polos — neutro conmutado' },
        ],
        rows: [
          { label: { en: 'Separately derived?', es: '¿Derivado por separado?' }, cells: [ { en: 'No', es: 'No' }, { en: 'Yes', es: 'Sí' } ] },
          { label: { en: 'Neutral–ground bond', es: 'Unión neutro–tierra' }, cells: [ { en: 'ONLY at the service (remove/verify the generator’s bonding jumper; use a floating-neutral portable)', es: 'SOLO en la acometida (quita/verifica el puente del generador; usa portátil de neutro flotante)' }, { en: 'At the generator (bonded-neutral)', es: 'En el generador (neutro unido)' } ] },
          { label: { en: 'Grounding electrode at gen?', es: '¿Electrodo de tierra en el gen?' }, cells: [ { en: 'No — uses the service ground', es: 'No — usa la tierra de la acometida' }, { en: 'Yes — provide one (250.30)', es: 'Sí — provee uno (250.30)' } ] },
          { label: { en: 'Typical use', es: 'Uso típico' }, cells: [ { en: 'Interlocks and most home ATS', es: 'Interbloqueos y la mayoría de ATS de casa' }, { en: 'Where the neutral must be isolated', es: 'Donde el neutro debe aislarse' } ] },
        ],
      },
      { type: 'heading', text: { en: 'Signs, permits & inspection', es: 'Señalización, permiso e inspección' } },
      {
        type: 'list',
        items: [
          { en: 'Post a sign at the service disconnect indicating there is an on-site optional standby source and where it is (702.7).', es: 'Coloca un letrero en la desconexión de la acometida indicando que hay una fuente de respaldo opcional en sitio y dónde está (702.7).' },
          { en: 'Pull the electrical permit (and gas/mechanical if applicable) and pass inspection.', es: 'Saca el permiso eléctrico (y de gas/mecánico si aplica) y pasa la inspección.' },
          { en: 'Notify the utility (FPL) — the transfer equipment protects their crews; some require notice for on-site generation.', es: 'Notifica a la compañía (FPL) — el equipo de transferencia protege a sus cuadrillas; algunas requieren aviso de generación en sitio.' },
        ],
      },
      {
        type: 'callout',
        kind: 'warning',
        text: {
          en: 'The two ways generators kill: (1) CO — never run a portable indoors or in a garage. (2) Backfeed — never connect a generator without a listed transfer switch or interlock; a “suicide cord” energizes the utility line and can kill a lineman.',
          es: 'Las dos formas en que los generadores matan: (1) CO — nunca uses un portátil adentro ni en un garaje. (2) Backfeed — nunca conectes un generador sin transferencia o interbloqueo listado; un “cable suicida” energiza la línea de la red y puede matar a un liniero.',
        },
      },
      {
        type: 'callout',
        kind: 'tip',
        text: {
          en: 'Quick recap: outside (portable) · transfer switch or listed interlock · match the neutral bond to the transfer type · manufacturer clearances · sign at the panel · permit + inspection.',
          es: 'Resumen: afuera (portátil) · transferencia o interbloqueo listado · unir el neutro según el tipo de transferencia · distancias del fabricante · letrero en el panel · permiso + inspección.',
        },
      },
    ],
  },
